...
namespace MrPathV2
{
    public static class PathSampler
    {
        ...
        private static PathSpine ProjectSpineToTerrain(PathSpine sourceSpine, IHeightProvider heightProvider, float snapStrength, int heightSmoothness)
        {
        ...
        private static Vector3[] GetSurfaceNormals(Vector3[] points, IHeightProvider heightProvider)
        {

...
namespace __temp.MrPathV2.Runtime.Core
{
    ...
    public class AddPointCommand : PathChangeCommand
    {
        ...
        public AddPointCommand(Vector3 position)
        {
            Position = position;
        }
        ...
        public override void Execute(PathCreator creator)
        {
            ...
            {
                var lastPoint = creator.transform.TransformPoint(creator.pathData.GetPosition(creator.pathData.KnotCount - 1));
    ...
    public class InsertPointCommand : PathChangeCommand
    {
        ...
        public InsertPointCommand(int segmentIndex, Vector3 position)
        {
    ...
    public class DeletePointCommand : PathChangeCommand
    {
        ...
        public DeletePointCommand(int pointFlatIndex)
        {
    ...
    public class ClearPointsCommand : PathChangeCommand
    {
        public override void Execute(PathCreator creator)
        {
            ...
            {
                // 保存第一个点的位置
                var firstPointPosition = creator.pathData.GetPosition(0);

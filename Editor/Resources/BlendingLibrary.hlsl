...
{
    float softR = (overlay.r < 0.5) ? (2.0 * base.r * overlay.r + base.r * base.r * (1.0 - 2.0 * overlay.r)) : (sqrt(max(0.0, base.r)) * (2.0 * overlay.r - 1.0) + 2.0 * base.r * (1.0 - overlay.r));
    float softG = (overlay.g < 0.5) ? (2.0 * base.g * overlay.g + base.g * base.g * (1.0 - 2.0 * overlay.g)) : (sqrt(max(0.0, base.g)) * (2.0 * overlay.g - 1.0) + 2.0 * base.g * (1.0 - overlay.g));
    float softB = (overlay.b < 0.5) ? (2.0 * base.b * overlay.b + base.b * base.b * (1.0 - 2.0 * overlay.b)) : (sqrt(max(0.0, base.b)) * (2.0 * overlay.b - 1.0) + 2.0 * base.b * (1.0 - overlay.b));
    float softA = (overlay.a < 0.5) ? (2.0 * base.a * overlay.a + base.a * base.a * (1.0 - 2.0 * overlay.a)) : (sqrt(max(0.0, base.a)) * (2.0 * overlay.a - 1.0) + 2.0 * base.a * (1.0 - overlay.a));

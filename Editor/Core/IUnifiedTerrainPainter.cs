...
using __temp.MrPathV2.Editor.GPU; // Use V2 GPU painter

namespace __temp.MrPathV2.Editor.Core
{
    // 统一地形画笔接口，支持 using 释放与异步/同步绘制
    public interface IUnifiedTerrainPainter : System.IDisposable
    {
    ...
    /// <summary>
    /// 缂傚倸鍊烽悞锕傛晪闂佺硶鏅?鐎规洘濞婃俊鎼佸Ψ閵堝洨鐓戦梻?- 闂備礁鎼?粔?閻庤?鎸烽懗鍫曞礌閺?鍤掗柕鍫濇搐閻撴岸姊绘担瑙勭凡缂佸?鐖奸幃鍧楀幢濞戞ɑ銇濋柣蹇曞仱閻?浠氶悷婊勫灴瀹曟??鑱欐俊?娴囨禒姘?攽?閹虫捇宕愰懗?绮存繝銏ｆ硾??闂備礁鎼?悡?浠氬┑鐐舵彧缁茬晫澹?閸?鐎规洘姘ㄩ幑鍕?倻濡?厧缍?
    /// </summary>
    public static class UnifiedPainterFactory
    {
        ...
        /// </summary>
        /// <param name="preferredType">濠?缁查箖鎮ч悩杞扮泊婵犮垼娉涢惉鑲╂暜濞戙垺鐓曢柟鐑樻礃绾?偓绻涢崨?绗ч柣姘?⒔閹风娀鎳?鑱?/param>
        /// <param name="terrain">闂?闂佺粯鐗?紞浣哥暦閻戣棄绾ч柤?閻?/param>
        /// <param name="pathBounds">闂?缂備礁澧庨崑鐐?韫囨稑鎹?婵炲懏娲熼弻銊モ槈濡?厧鈪遍梺杞伴檷閸婃牜绮嬪?鍡樺劅闁抽攱?鑱欓悷婊勫灴瀹曟?螣閸忕厧鐝伴梺?鐎?鍏橀弻?/param>
